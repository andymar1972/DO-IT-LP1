...
(
    ...
    CELULAR_APO_CONTACTO  VARCHAR(9),
    FONO_APO_CONTACTO     VARCHAR(6),
    CORREO_APO_CONTACTO	  VARCHAR(30),
...
(
    ...
    FONO_ALU_CONTACTO     VARCHAR(6),
    CORREO_ALU_CONTACTO	  VARCHAR(30),
    FECHA_NAC DATE NOT NULL
);

INSERT INTO TB_ALUMNO VALUES('72280703','ANDY','MARIÑOS','RODRIGUEZ',null,null,null,'2001-08-01');
INSERT INTO TB_ALUMNO VALUES('74690086','LUIS','RETTO','HERNANDEZ',929470244,null,'luis23_10_98@hotmail.com','1998-10-23');
...
INSERT INTO TB_USUARIO VALUES('U00001','Navidad','JULIAN','HUAMANI','QUISPE','1900-04-06','A');
INSERT INTO TB_USUARIO VALUES('U00002','Pascua','MERCEDEZ','RODRIGUEZ','SANTOS','1995-01-06','S');
...
select * from TB_USUARIO
 where COD_USUARIO=usr and CONTRASEÑA = pas;
END $$
DELIMITER ;